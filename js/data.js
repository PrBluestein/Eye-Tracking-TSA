...
// Zones disponibles
const zones = {
  ecran: { label: 'Écran', color: '#009DC1' }, // Primary Blue
  tete: { label: 'Tête', color: '#83C5BE' },   // Keep teal for head
  yeux: { label: 'Yeux', color: '#FF5852' },   // Distinctive Red
  bouche: { label: 'Bouche', color: '#F4D35E' } // Keep yellow
};

// Couleurs des groupes (Graphic Charter - DA)
const groupColors = {
  dt: '#FF5852',      // Distinctive Red (DT in Puzzle/First Chart)
  tsa: '#005291',     // Marine Blue (TSA in Puzzle/First Chart)
  average: '#009DC1'  // Primary Blue (Average)
};
