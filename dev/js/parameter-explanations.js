...
// Definitions for each eye-tracking parameter

const parameterDefinitions = {
    ttt: {
        name: "Temps Total Tracké",
        abbr: "TTT",
        icon: "assets/icons/icon-ttt.svg",
    ...
    nbf: {
        ...
        abbr: "NBF",
        icon: "assets/icons/icon-nbf.svg",
    ...
    nbe: {
        ...
        abbr: "NBE",
        icon: "assets/icons/icon-nbe.svg",
    ...
    latence: {
        name: "Latence",
        abbr: "Lat",
        icon: "assets/icons/icon-latence.svg",
...
// Initialize parameter cards with click handlers
document.addEventListener('DOMContentLoaded', () => {
    // Create modal on page load
    createParameterModal();

    // Add click handlers to all parameter cards
    const parameterCards = document.querySelectorAll('.parameter-card');
    parameterCards.forEach(card => {
        // Determine which parameter this is based on the text content
