/**
 * Mascot Logic - Le Prof
 * Handles talking animation and section-based messages
 */
...
const Mascot = (() => {
    ...
    const init = () => {
        ...
        // Determine if we are on index, soutenance or analyse
    ...
    const setupSlideListener = (msgs) => {
        // We can hook into the existing updateSlide logic if we want, 
        // or just watch the hash or use a custom event.
        // For simplicity, let's watch the hash change
